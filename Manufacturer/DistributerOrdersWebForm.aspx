<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DistributerOrdersWebForm.aspx.cs" EnableEventValidation="false" Inherits="Register_Login.Manufacturer.DistributerOrdersWebForm" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
        <title>Pending Distributer Requests Management</title>
    <style>
        body {
    ...
    <form id="form1" runat="server">
        <div class="container">
            ...
            <asp:GridView ID="gvPendingRequests" runat="server" CssClass="grid-view" AutoGenerateColumns="false" 
                    ...
                    DataKeyNames="DistributerRrequestID" OnRowDataBound="gvPendingRequests_RowDataBound"
                    EnableViewState="true">
                <Columns>
                    <asp:BoundField DataField="DistributerRrequestID" HeaderText="Request ID" />
                    <asp:BoundField DataField="DistributerName" HeaderText="Seller" />
                    <asp:BoundField DataField="BlanketModel" HeaderText="Blanket Model" />
