<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ManufacturerRejectRequestsWebForm.aspx.cs" Inherits="Register_Login.Manufacturer.ManufacturerRejectRequestsWebForm" %>
...
<body>
    <form id="form1" runat="server">
        <div class="container">
            ...
            <asp:GridView ID="gvRejectedRequests" runat="server" CssClass="grid-view" AutoGenerateColumns="false">
                <Columns>
                    <asp:BoundField DataField="DistributerRrequestID" HeaderText="Request ID" />
                    <asp:BoundField DataField="DistributerName" HeaderText="Seller Name" />
                    ...
                    <asp:TemplateField HeaderText="Status">
                        <ItemTemplate>
                            <span class="status-rejected"><%# Eval("Status") %></span>
                        </ItemTemplate>
                    </asp:TemplateField>
