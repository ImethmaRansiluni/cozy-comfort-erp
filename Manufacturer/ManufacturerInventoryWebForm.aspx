<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ManufacturerInventoryWebForm.aspx.cs" Inherits="Register_Login.Manufacturer.ManufacturerInventoryWebForm" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
       <title>Manage Manufacturer Inventory</title>
    <style>
        body {
...
<body>
    <form id="form1" runat="server">
        <div class="form-container">
            <h2>Manage Manufacturer Inventory</h2>
            ...
            <asp:GridView ID="gvInventory" runat="server" AutoGenerateColumns="false" CssClass="grid-view"
                ...
                <Columns>
                    <asp:BoundField DataField="ManufacturerInventoryID" HeaderText="Inventory ID" />
