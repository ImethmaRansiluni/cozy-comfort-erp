<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DistributerCurrentStockWebForm.aspx.cs" Inherits="Register_Login.Distributer.DistributerCurrentStockWebForm" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
        <title>Distributer Current Stock</title>
    <style>
        body {
...
<body>
    <form id="form1" runat="server">
        <div class="container">
            <div class="header">
                <h2>Distributer Current Stock</h2>
            </div>
