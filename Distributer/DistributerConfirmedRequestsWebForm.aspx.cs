...
{
    public partial class DistributerConfirmedRequestsWebForm : System.Web.UI.Page
    {
        ...
        private void LoadConfirmedRequests()
        {
            ...
            try
            {
              DataSet confirmedRequests = obj.GetConfirmedRequestsByDistributer(distributerId);
