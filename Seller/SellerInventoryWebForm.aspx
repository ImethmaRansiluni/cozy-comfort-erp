<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SellerInventoryWebForm.aspx.cs" Inherits="Register_Login.Seller.SellerInventoryWebForm" %>
    ...
    <form id="form1" runat="server">
        <div class="form-container">
            ...
            <div class="form-group">
                ...
                <asp:TextBox ID="txtInventoryID" runat="server" CssClass="form-control"></asp:TextBox>
            </div>
            ...
            <asp:GridView ID="gvInventory" runat="server" AutoGenerateColumns="false" CssClass="grid-view"
                ...
                <Columns>
                     <asp:BoundField DataField="SellerInventoryID" HeaderText="Inventory ID" />
