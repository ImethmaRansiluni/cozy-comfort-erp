<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SellerRequestWebForm.aspx.cs" Inherits="Register_Login.Seller.SellerRequestWebForm" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Seller Requests Form</title>
    <style>
        /* Base Styles */
        body {
...
<body>
    <form id="form1" runat="server">
        <div class="container">
            <div class="header">
                <h2>Seller Inventory Management</h2>
            </div>
